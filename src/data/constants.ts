...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Developed and maintained full-stack web applications, ensuring high performance and scalability.",
      "Collaborated with cross-functional teams to deliver user-centric solutions within deadlines.",
      "Gained experience in front-end and back-end technologies, optimizing application functionality and user experience.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.FIREBASE,
  ...
  },
  {
    ...
    endDate: "Jul 2024",
    title: "Mentor",
    company: "MentorNations",
    description: [
      "Mentored 100+ aspiring developers in web development, offering guidance on technical concepts and career growth.",
      "Helped organize and deliver 5+ bootcamps and hackathons funded by the U.S. Embassy, empowering participants with practical skills.",
      "Assisted in curriculum development and hands-on workshops to enhance learning outcomes and foster innovation.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
